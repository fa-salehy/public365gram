                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input name="firstName" type="text" class="form-control"
                                                       id="exampleInputEmail1" placeholder="نام کاربر"
                                                       oninvalid="this.setCustomValidity('نام را وارد کنید')"
                                                       oninput="this.setCustomValidity('')" value="{{old('firstName')}}"
                                                       required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">نام خانوادگی</label>
                                                <input name="lastName" type="text" class="form-control"
                                                       id="exampleInputEmail1" placeholder="نام خانوادگی کاربر"
                                                       oninvalid="this.setCustomValidity('نام خانوادگی را وارد کنید')"
                                                       oninput="this.setCustomValidity('')" value="{{old('lastName')}}"
                                                       required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">ایمیل</label>
                                                <input name="email" type="email" class="form-control"
                                                       id="exampleInputEmail1" placeholder="ایمیل کاربر"
                                                       oninvalid="this.setCustomValidity('ایمیل را وارد کنید')"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="phone" type="number" class="form-control"
                                                       id="exampleInputPassword1" placeholder="تلفن همراه"
                                                       oninvalid="this.setCustomValidity('تلفن همراه را وارد کنید')"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="password" type="password" class="form-control"
                                                       id="exampleInputPassword1" placeholder="رمز عبور"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="password_confirmation" class="form-control"
                                                       id="exampleInputPassword1" placeholder="تکرار رمز عبور"
