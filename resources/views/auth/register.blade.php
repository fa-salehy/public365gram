                                    ...
                                    <div class="card-body mt-2 mb-2">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group text-right">
                                                <label>نام</label>
                                                <input name="firstName" class="form-control" placeholder="نام خود را وارد کنید" type="text">
                                            </div>
                                            <div class="form-group text-right">
                                                <label>نام خانوادگی</label>
                                                <input name="lastName" class="form-control" placeholder="نام خانوادگی خود را وارد کنید" type="text">
                                            </div>
                                            <div class="form-group text-right">
                                                <label>گروه حمایتی</label>
                                                <input name="page" class="form-control" placeholder="نام گروه حمایتی خود را وارد کنید" type="text">
                                            </div>
                                            <div class="form-group text-right">
                                                <label>شماره موبایل واتس اپ</label>
                                                <input name="phone" class="form-control" placeholder="شماره واتس اپ خود را وارد کنید" type="number" >
                                            </div>
                                            <div class="form-group text-right">
